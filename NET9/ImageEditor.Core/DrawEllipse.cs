    ...
    public class DrawEllipse : DrawRectangle
    {
        ...
        private static void ApplyPenType(SKPaint paint, DrawingPens.PenType penType, float strokeWidth)
        {
            ...
            switch (penType)
            {
                ...
                case DrawingPens.PenType.DashDotDot:
                    paint.PathEffect = SKPathEffect.CreateDash(new float[] { 6 * strokeWidth, 3 * strokeWidth, strokeWidth, 3 * strokeWidth, strokeWidth, 3 * strokeWidth }, 0);
                    break;
