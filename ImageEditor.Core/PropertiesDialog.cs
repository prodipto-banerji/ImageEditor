...

{
...

    {
        ...
        /// <summary>
        /// Legacy compatibility method — replaces old WinForms ShowDialog().
        /// Simulates a modal dialog and returns DialogResult.OK by default.
        /// </summary>
        public DialogResult ShowDialog(object parent = null)
        {
            // Simulate the old WinForms behavior — no actual UI shown.
            // You can extend this later to open a custom WinForms window if needed.
...

        {
            ...
            return properties.Color ?? Color.Black;
...

        {
            ...
            string colorName = properties.Color?.Name ?? Undefined;
